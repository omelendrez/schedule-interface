<template>
  <b-navbar toggleable="md" type="dark" variant="dark">
    ...
    <b-navbar-brand href="#/">
      <i class="fas fa-home"></i> Turnos Big Six
    </b-navbar-brand>
    <b-collapse is-nav id="nav_collapse">
      <template v-if="isLogged">
        <b-navbar-nav class="admin">
          ...
          <b-nav-item v-bind:active="menuOption === '/employees'" class="_employees" href="#/employees">Empleados
          </b-nav-item>
          <b-nav-item v-bind:active="menuOption === '/absenteeisms'" href="#/absenteeisms">Tipos de Ausentismo
          </b-nav-item>
        </b-navbar-nav>
